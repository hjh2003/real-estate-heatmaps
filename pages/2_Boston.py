...
# Page title
st.title("Boston Real Estate Visualization")

# Define the HTML file paths for each map visualization
html_files = {
    'New Listings': 'Maps/Boston/Boston_new_listings_map.html',
    'Homes Sold': 'Maps/Boston/Boston_homes_sold_map.html',
    'Off Market in Two Weeks': 'Maps/Boston/Boston_off_market_in_two_weeks_map.html',
    'Median Sale Price': 'Maps/Boston/Boston_median_sale_price_map.html',
    'Median Days on Market': 'Maps/Boston/Boston_median_dom_map.html',
}
...
if selected_field == 'New Listings':
    explanation = "This map shows the new listings of residential properties in Boston. Explore the areas with the highest new listing activity."
elif selected_field == 'Homes Sold':
    explanation = "This map displays the number of homes sold in different neighborhoods of Boston. Observe the areas with the most home sales."
    ...
    explanation = "Explore the median sale price of residential properties in Boston. The darker the color, the higher the median sale price."
