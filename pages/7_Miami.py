...
# Page title
st.title("Miami Real Estate Visualization")

# Define the HTML file paths for each map visualization
html_files = {
    'New Listings': 'Maps/Miami/Miami_new_listings_map.html',
    'Homes Sold': 'Maps/Miami/Miami_homes_sold_map.html',
    'Off Market in Two Weeks': 'Maps/Miami/Miami_off_market_in_two_weeks_map.html',
    'Median Sale Price': 'Maps/Miami/Miami_median_sale_price_map.html',
    'Median Days on Market': 'Maps/Miami/Miami_median_dom_map.html',
}
...
if selected_field == 'New Listings':
    explanation = "This map shows the new listings of residential properties in Miami. Explore the areas with the highest new listing activity."
elif selected_field == 'Homes Sold':
    explanation = "This map displays the number of homes sold in different neighborhoods of Miami. Observe the areas with the most home sales."
    ...
    explanation = "Explore the median sale price of residential properties in Miami. The darker the color, the higher the median sale price."
